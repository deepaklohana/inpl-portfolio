...
export default function ProductHero() {
  return (
    <section className="relative w-full overflow-hidden bg-white min-h-[698px] flex items-center justify-center pt-24 pb-16">
      ...
      {/* Content */}
      <div className="relative z-10 w-full max-w-[990px] mx-auto px-4 md:px-8 md:mb-20 mb-10 text-center flex flex-col items-center gap-12">
        ...
        <div className="flex flex-col items-center gap-4 w-full max-w-[885px]">
