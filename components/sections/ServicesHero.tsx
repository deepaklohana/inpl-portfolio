    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden sm:flex justify-center hidden">
        <div className="relative w-[1440px] h-full max-w-full">
          ...
          <div className="absolute w-[343px] h-[307px] left-[183px] top-[80px] bg-[rgba(255,154,109,0.2)] blur-[100px] rounded-full" />
          {/* Ellipse 2 — rgba(67,126,253,0.2) */}
          <div className="absolute w-[343px] h-[307px] left-[914px] top-[166px] bg-[rgba(67,126,253,0.2)] blur-[100px] rounded-full" />
          {/* Ellipse 4 — rgba(47,103,223,0.3) */}
          <div className="absolute w-[288px] h-[258px] left-[234px] top-[294px] bg-[rgba(47,103,223,0.3)] blur-[100px] rounded-full" />
          {/* Ellipse 5 — rgba(162,223,47,0.2) */}
          <div className="absolute w-[288px] h-[258px] left-[873px] top-[325px] bg-[rgba(162,223,47,0.2)] blur-[100px] rounded-full" />
        </div>
      </div>
      ...
      {/* Content */}
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 md:px-8 text-center flex flex-col items-center gap-12 mt-12 md:mt-0">
        <div className="flex flex-col items-center gap-6 w-full">
          ...
          <div className="flex flex-col items-center gap-4 w-full max-w-[896px]">
            <h1 className="text-4xl sm:text-5xl md:text-[72px] font-bold text-[#101828] leading-[1.1] tracking-[-0.025em] font-['Inter',sans-serif] whitespace-pre-line">
              {title}
            </h1>
