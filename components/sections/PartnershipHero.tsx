...
export default function PartnershipHero() {
  return (
    <section className="relative w-full overflow-hidden bg-white min-h-[583px] flex items-center justify-center pt-24 pb-16">
      ...
      {/* Content */}
      <HeroReveal className="relative z-10 w-full max-w-[990px] mx-auto px-4 md:px-8 text-center flex flex-col items-center gap-[24px]">
        {/* Badge */}
        ...
        <div className="flex flex-col items-center gap-4 w-full">
          {/* Headline */}
          <h1 className="text-4xl sm:text-5xl md:text-[72px] font-bold text-[#101828] leading-[1.1] tracking-[-0.025em] font-['Plus_Jakarta_Sans',sans-serif] w-full max-w-[885px]">
            Building Success<br /><span className="text-[#2251B5]">Together</span>
          </h1>
          
          {/* Subtitle */}
          <p className="text-base sm:text-lg md:text-[24px] text-[#4A5565] leading-relaxed max-w-[990px] font-['Inter',sans-serif]">
            Collaborating with industry leaders to deliver exceptional value and drive innovation across the global technology ecosystem.
          </p>
        </div>
