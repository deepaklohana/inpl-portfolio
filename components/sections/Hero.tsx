...
export default function Hero() {
  return (
    <section className="relative w-full overflow-hidden bg-white min-h-[740px] flex items-center justify-center pt-24 pb-16">
      ...
      {/* Content */}
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 md:px-8 text-center flex flex-col items-center gap-12">
        ...
        <div className="flex flex-col items-center gap-[15px] w-full max-w-[885px]">
